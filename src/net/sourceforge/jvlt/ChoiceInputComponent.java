...
public class ChoiceInputComponent extends ListeningInputComponent {
	...
	public Object getInput() {
		...
		// has entered data.
		Object obj = _input_box.isEditable() ?
			_input_box.getEditor().getItem() : _input_box.getSelectedItem();
		if (obj == null)
			return null;
	...
	protected ChoiceInputComponent(LabeledComboBox input_box) {
		...
		_input_box.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) { fireChangeEvent(); }
		});
		_input_box.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { fireChangeEvent(); }
		});
	}
