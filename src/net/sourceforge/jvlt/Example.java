...
public class Example implements Reinitializable, Comparable<Example> {
	...
	public static class TextFragment {
		...
		public TextFragment (String text) { this(text, null); }
		
		public TextFragment () { this("", null); }
		...
		public void setSense (Sense sense) { _sense = sense; }
	 ...
	 * Example.TextFragment are copied, but not the text fragment's
	...
	public String getText () {
		...
		Iterator<TextFragment> it=_fragments.iterator();
		while (it.hasNext()) {
			TextFragment tf = (TextFragment) it.next();
			text+=tf.getText();
		}
	...
	public void setTranslation (String t) { _translation = t; }

	public void addTextFragment(TextFragment fragment) {
		_fragments.add(fragment);
	}
	
	public void insertTextFragmentBefore (
		TextFragment fragment, TextFragment before) {
		int index = _fragments.indexOf(before);
		_fragments.add (index, fragment);
	}
		
	public void insertTextFragmentAfter (
		TextFragment fragment, TextFragment after) {
	...
	public int compareTo (Example e) { return _id.compareTo(e.getID()); }
	
	/**
	 * Returns true if <i>o</i> is a clone of this example or if <i>o</i>
	 * and this example are the same object. */
