...
public class ItemContainer {
	...
	public Object[] getItems() { return _values.toArray(); }
	...
	public void addItem(Object item) {
		String translation = _translate_items ?
			_resources.getString(item.toString()) : item.toString();
	...
	public void removeAllItems() { _values.clear(); }
	...
	public boolean getTranslateItems() { return _translate_items; }
