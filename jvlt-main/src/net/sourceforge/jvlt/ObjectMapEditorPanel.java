...
public abstract class ObjectMapEditorPanel<T extends Object> extends JPanel {
	...
	public Object getSelectedItem() { return _name_box.getSelectedItem(); }

	public void setSelectedItem(Object o) { _name_box.setSelectedItem(o); }
	
	public Map<Object, T> getItems() { return _item_map; }
