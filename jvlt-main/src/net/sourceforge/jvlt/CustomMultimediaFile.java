...
class CustomMultimediaFile extends MultimediaFile {
	...
	public CustomMultimediaFile (String file_name) { super(file_name); }
	
	public CustomMultimediaFile (int type) { this("", type); }
