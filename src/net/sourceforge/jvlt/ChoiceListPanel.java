...
/**
 * A panel for managing lists of objects.
 * The items that are added to the list are selected via a combo box.
 * The objects available in the combo box can be set by calling
 * {@link #setAvailableObjects}. Method {@link #setAllowCustomChoices}
 * allows to make the combo box editable, so that arbitrary strings can
 * be added.
 */
public class ChoiceListPanel extends ObjectListPanel {
	...
	public ChoiceListPanel() { this(new ChoiceInputComponent()); }
