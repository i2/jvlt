...
public class EditDictObjectAction extends DictObjectAction {
	...
	public EditDictObjectAction (Reinitializable obj) { this (obj, null); }
	
	public void setNewData (Reinitializable new_data) { _new_data = new_data; }
	
	public Reinitializable getOldData () { return _old_data; }
	
	public Reinitializable getNewData () { return _new_data; }
