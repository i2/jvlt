...
public class YesNoPanel extends JPanel implements ItemListener {
	...
	public void setMessage(String msg) { _message_label.setText(msg); }

	public void addStateListener(StateListener l) { _listeners.add(l); }
	
	public void removeStateListener(StateListener l) { _listeners.remove(l); }
