...
class MessageDialog extends JDialog implements ActionListener {
	...
	private static MessageDialog _dialog = null;
	
	private boolean _show_details = false;
	private int _options = OK_OPTION;
	private int _result = OK_OPTION;
	
	private Action _details_action;
	private JButton _ok_button;
	private JButton _cancel_button;
	private JButton _details_button;
	private JLabel _message_label;
	private JScrollPane _details_scrpane;
	private JTextArea _details_area;
	private JLabel _icon_label;
	private JPanel _button_panel;
	private JPanel _content_pane;
	private String _details;
	
	public MessageDialog(Frame parent, int type, int options,
	...
	public MessageDialog(Dialog parent, int type, int options,
		String message, String details) {
		super(parent, true);
		_options = options;
		init(type, message, details);
	...
	public MessageDialog(Frame parent, int type,
		String message, String details) {
		this(parent, type, OK_OPTION, message, details); }
	
	public MessageDialog(Dialog parent, int type,
		String message, String details) {
		this(parent, type, OK_OPTION, message, details); }
	...
	public static int showDialog(Component parent, int type,
		String message, String details) {
	...
	public static int showDialog(Component parent, int type, int options,
		...
		if (comp instanceof Dialog)
			_dialog = new MessageDialog(
				(Dialog) comp, type, options, message, details);
		else // if (comp instanceof Frame)
			_dialog = new MessageDialog (
				(Frame) comp, type, options, message, details);
	...
	private void initUI() {
		...
		_details_scrpane.setBorder(new TitledBorder(new EtchedBorder(
			EtchedBorder.LOWERED), GUIUtils.getString("Labels", "details")));
