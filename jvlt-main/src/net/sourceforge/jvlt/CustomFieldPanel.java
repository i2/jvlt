...
public class CustomFieldPanel extends JPanel {
	...
	private static class CustomFieldCellRenderer
		...
		public Component getTableCellRendererComponent(
			...
			if (value == null)
				label.setText(GUIUtils.getString(
						"Labels", "double_click_to_edit"));
	...
	private static class CustomFieldCellEditor extends DefaultCellEditor {
		...
		public CustomFieldCellEditor(JComboBox box) { super(box); }
		
		public CustomFieldCellEditor(JTextField field) { super(field); }
