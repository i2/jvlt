...
public class FontChooserComboBox extends JComboBox {
	public static final String DEFAULT_STRING =
		GUIUtils.getString("Labels", "use_default");
	public static final String CHOOSE_STRING =
		GUIUtils.getString("Labels", "choose_font");
	...
	private class Model extends DefaultComboBoxModel {
		...
		@Override
		public int getSize() { return fontInfo == null ? 2 : 3; }
		...
		public Object getElementAt(int index) {
			...
			case 1:
				return fontInfo == null ? CHOOSE_STRING
						: fontInfo.getFamily() + " " + fontInfo.getSize();
			case 2:
