...
/**
 * Query item that contains other query items. This class can be used when
 * a match-all query should contain a match-one query. The attribute name
 * has to be equal for all query items.  
 */
public class ContainerQueryItem extends ObjectQueryItem {
	...
	private ArrayList<ObjectQueryItem> _items =
		new ArrayList<ObjectQueryItem>();
	
	public ContainerQueryItem(String name, int type) {
		super(name, type, null);
	}

	public ContainerQueryItem() { this(null, MATCH_ONE); }
