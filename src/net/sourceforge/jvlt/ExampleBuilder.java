...
public class ExampleBuilder {
	...
	public ExampleBuilder(Example example) { _example = example; }
	...
	public void addSense(Sense sense, int start_index, int end_index)
		...
		if (tfs.length != 1)
			throw new DictException(
				GUIUtils.getString("Messages", "selection_too_large"));
		
		Example.TextFragment tf = tfs[0];
		if (tf.getSense() != null)
			throw new DictException(
				GUIUtils.getString("Messages", "selection_already_linked"));
	...
	private Example.TextFragment[] getTextFragments(
