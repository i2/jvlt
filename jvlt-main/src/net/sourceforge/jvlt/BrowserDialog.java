...
class Browser extends JPanel {
	...
	private void init() {
		_back_action = GUIUtils.createIconAction(
			new ActionEventHandler(), "back");
		_forward_action = GUIUtils.createIconAction(
			new ActionEventHandler(), "forward");
		ButtonPanel button_panel = new ButtonPanel(
			SwingConstants.HORIZONTAL, SwingConstants.LEFT);
