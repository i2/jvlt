...
public class MetaData {
	...
	public Attribute getAttribute (String name) {
		return (Attribute) _name_map.get(name);
	}
	
	/**
	 * Returns the list of attributes.
	 * An attribute is represented by a public method with prefix "get"
	 * and with no parameters. */
	public Attribute[] getAttributes() {
		return (Attribute[]) _attributes.toArray(new Attribute[0]);
	}
		
	public String[] getAttributeNames() {
		return (String[]) _names.toArray(new String[0]);
	}
