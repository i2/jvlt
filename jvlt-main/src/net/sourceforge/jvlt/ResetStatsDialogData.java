...
public class ResetStatsDialogData extends CustomDialogData {
	private class ActionHandler implements ActionListener {
		public void actionPerformed(ActionEvent ev) { updateLabelText(); }
	}
	...
	public ResetStatsDialogData(int num_entries, int num_matched_entries) {
		...
		_all_entries_button = new JRadioButton(
				GUIUtils.createTextAction(handler, "all_entries"));
		_all_entries_button.setSelected(true);
		_displayed_entries_button = new JRadioButton(
				GUIUtils.createTextAction(handler, "vocabulary_list_words"));
